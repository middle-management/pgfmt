...
SELECT
	t.id
FROM
	test_tablesample AS t TABLESAMPLE system (50) REPEATABLE (0);
...
FROM
	copy_t
ORDER BY
	a) TO STDOUT WITH (DELIMITER ',', FORMAT csv, HEADER true);
...
INSERT INTO
	odd_names ("mixed Case column")
VALUES (10);

SELECT
	'999'::interval second(3);
...
SELECT
	XMLPARSE(CONTENT doc PRESERVE WHITESPACE)
FROM
	x;
...
CREATE SEQUENCE seq_typed AS smallint INCREMENT BY 2;
