...
INSERT INTO studio.permission (type, description, metadata, created_at)
VALUES
...
INSERT INTO tags (id, name) VALUES (1, 'red'), (2, 'green'), (3, 'blue');
...
ON CONFLICT (name) DO UPDATE SET hits = counters.hits + 1 WHERE counters.hits < 100;
