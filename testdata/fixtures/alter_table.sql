...
ALTER TABLE ONLY parted ADD CONSTRAINT c CHECK (a > 0) NOT VALID;

ALTER TABLE m ATTACH PARTITION p1 FOR VALUES FROM (1) TO (10);

ALTER TABLE m ATTACH PARTITION pdef DEFAULT;

ALTER TABLE m DETACH PARTITION p1 CONCURRENTLY;

ALTER TABLE t VALIDATE CONSTRAINT c;

ALTER INDEX i ALTER COLUMN 2 SET STATISTICS 100;
...
ALTER TABLE t INHERIT parent, NO INHERIT other_parent;
...
ALTER TABLE t ADD PRIMARY KEY USING INDEX pkidx;
...
CREATE TABLE nulls_unique (id int, a int, UNIQUE NULLS NOT DISTINCT (id) INCLUDE (a));
